...
var ReactSuperSelect = React.createClass({
  ...
  getInitialState: function getInitialState() {
    return {
      ...
      labelKey: this.props.optionLabelKey || 'label',
      ...
      valueKey: this.props.optionValueKey || 'value',
  ...
  _getOptionValueFromDataAttr: function _getOptionValueFromDataAttr(optionNode) {
  ...
  _getSelectionButtons: function _getSelectionButtons() {
    return React.createElement(
      'div',
      { className: 'r-ss-selection-buttons' },
      React.createElement(
        'a',
        { href: '#_', onClick: this._selectAll },
        'Vybrat vše'
      ),
      React.createElement(
        'a',
        { href: '#_', onClick: this._clearSelection },
        'Vymazat'
      )
    );
  },

  _getControlButtons: function _getControlButtons() {
    return React.createElement(
      'div',
      { className: 'r-ss-control-buttons' },
      React.createElement(
        'button',
        { className: 'r-ss-button-save btn btn-success', onClick: this._submit },
        'Uložit'
      )
    );
  },
    ...
    return _.map(data, function (dataOption, index) {
      ...
      return React.createElement(
        ...
        { ref: indexRef,
          ...
          role: 'option' },
        React.createElement('input', { type: 'checkbox', checked: isCurrentlySelected }),
        optionMarkup
      );
    }, this);
  },
